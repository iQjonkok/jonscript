...
echo color("green","| github: RSD123GLD |\n");
echo color("green","| fanspage :GAK DUE PENTING ISO GUYU\n");
echo color("green","| Creator : kang riname by GLD          |\n");
echo color("green","| FREE : JUAL AUTO BLOCK          |\n");
        ...
        if(strpos($register, '"otp_token"')){
			...
			if(strpos($verif, '"access_token"')){
				...
				if(strpos($code1, 'You can use this promo now...')){
					...
					echo "\n".color("yellow","!] Claim Voc PAKEGOJEK20");
					echo "\n".color("yellow","!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
					...
					sleep(3);
					$goride1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PAKEGOJEK20"}');
